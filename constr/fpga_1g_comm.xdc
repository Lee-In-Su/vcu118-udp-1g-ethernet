...
set_output_delay 0.000 [get_ports {phy_reset_n phy_mdio phy_mdc}]
set_false_path -from [get_ports {phy_int_n phy_mdio}]
set_input_delay 0.000 [get_ports {phy_int_n phy_mdio}]
...
# FMC+ HSPC J22
#set_property -dict {LOC AL35 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[0]}]  ;# J22.G9  LA00_P_CC
#set_property -dict {LOC AL36 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[0]}]  ;# J22.G10 LA00_N_CC
#set_property -dict {LOC AL30 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[1]}]  ;# J22.D8  LA01_P_CC
#set_property -dict {LOC AL31 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[1]}]  ;# J22.D9  LA01_N_CC
#set_property -dict {LOC AJ32 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[2]}]  ;# J22.H7  LA02_P
#set_property -dict {LOC AK32 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[2]}]  ;# J22.H8  LA02_N
#set_property -dict {LOC AT39 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[3]}]  ;# J22.G12 LA03_P
#set_property -dict {LOC AT40 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[3]}]  ;# J22.G13 LA03_N
#set_property -dict {LOC AR37 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[4]}]  ;# J22.H10 LA04_P
#set_property -dict {LOC AT37 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[4]}]  ;# J22.H11 LA04_N
#set_property -dict {LOC AP38 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[5]}]  ;# J22.D11 LA05_P
#set_property -dict {LOC AR38 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[5]}]  ;# J22.D12 LA05_N
#set_property -dict {LOC AT35 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[6]}]  ;# J22.C10 LA06_P
#set_property -dict {LOC AT36 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[6]}]  ;# J22.C11 LA06_N
#set_property -dict {LOC AP36 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[7]}]  ;# J22.H13 LA07_P
#set_property -dict {LOC AP37 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[7]}]  ;# J22.H14 LA07_N
#set_property -dict {LOC AK29 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[8]}]  ;# J22.G12 LA08_P
#set_property -dict {LOC AK30 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[8]}]  ;# J22.G13 LA08_N
#set_property -dict {LOC AJ33 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[9]}]  ;# J22.D14 LA09_P
#set_property -dict {LOC AK33 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[9]}]  ;# J22.D15 LA09_N
#set_property -dict {LOC AP35 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[10]}] ;# J22.C14 LA10_P
#set_property -dict {LOC AR35 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[10]}] ;# J22.C15 LA10_N
#set_property -dict {LOC AJ30 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[11]}] ;# J22.H16 LA11_P
#set_property -dict {LOC AJ31 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[11]}] ;# J22.H17 LA11_N
#set_property -dict {LOC AH33 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[12]}] ;# J22.G15 LA12_P
#set_property -dict {LOC AH34 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[12]}] ;# J22.G16 LA12_N
#set_property -dict {LOC AJ35 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[13]}] ;# J22.D17 LA13_P
#set_property -dict {LOC AJ36 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[13]}] ;# J22.D18 LA13_N
#set_property -dict {LOC AG31 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[14]}] ;# J22.C18 LA14_P
#set_property -dict {LOC AH31 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[14]}] ;# J22.C19 LA14_N
#set_property -dict {LOC AG32 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[15]}] ;# J22.H19 LA15_P
#set_property -dict {LOC AG33 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[15]}] ;# J22.H20 LA15_N
#set_property -dict {LOC AG34 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[16]}] ;# J22.G18 LA16_P
#set_property -dict {LOC AH35 IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[16]}] ;# J22.G19 LA16_N
#set_property -dict {LOC R34  IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_p[17]}] ;# J22.D20 LA17_P_CC
#set_property -dict {LOC P34  IOSTANDARD LVDS DIFF_TERM TRUE} [get_ports {fmcp_hspc_la_n[17]}] ;# J22.D21 LA17_N_CC
